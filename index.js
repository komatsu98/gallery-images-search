...
// looksSame('img/2.png', 'img/2cut.png', {tolerance: 5},  function(error, {equal}) {
//    console.log(equal)
// });
...
async function compare()
{
    ...
    const edinburgh_original = await Jimp.read("img/1.jpg");
    // const edinburgh_sharpened = await Jimp.read("2cut.jpg");
    // const edinburgh_bw = await Jimp.read("3.jpg");
    // const edinburgh_pixelized = await Jimp.read("2.jpg");
    const edinburgh_small = await Jimp.read("img/1com.png");
    const london = await Jimp.read("img/1.png");
